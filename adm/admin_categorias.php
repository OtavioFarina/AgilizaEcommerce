...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'create') {
    ...
    if (empty($nome_categoria)) {
        ...
        try {
            ...
            $_SESSION['mensagem'] = ['tipo' => 'sucesso', 'texto' => 'Categoria adicionada com sucesso!'];
        } catch (PDOException $e) {
            if ($e->getCode() == '23000') {
                $_SESSION['mensagem'] = ['tipo' => 'erro', 'texto' => 'Erro: Já existe uma categoria com este nome.'];
            } else {
                $_SESSION['mensagem'] = ['tipo' => 'erro', 'texto' => 'Erro ao adicionar categoria: ' . $e->getMessage()];
            }
        }
    }
    ...
    if (is_numeric($id_categoria) && $id_categoria > 0) {
        ...
        try {
            ...
            if ($e->getCode() == '23000' || $e->getCode() == '1451') {
                $_SESSION['mensagem'] = [
                    'tipo' => 'erro',
                    'texto' => 'Erro: Esta categoria não pode ser excluída pois está sendo usada por produtos cadastrados.'
                ];
            } else {
                $_SESSION['mensagem'] = ['tipo' => 'erro', 'texto' => 'Erro ao excluir categoria: ' . $e->getMessage()];
            }
        }
    } else {
...
try {
    ...
    $mensagem = ['tipo' => 'erro', 'texto' => 'Erro ao carregar categorias: ' . $e->getMessage()];
}
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <title>Gerenciar Categorias - Painel ADM</title>
    ...
    <div class="admin-container">
        ...
        <main class="admin-content">
            ...
            <div class="content-card">
                ...
                <form action="admin_categorias.php" method="POST" class="form-inline">
                        ...
                        <tbody>
                            <?php foreach ($categorias as $categoria): ?>
                                <tr>
                                    ...
                                    <td><strong><?php echo htmlspecialchars($categoria['nome_categoria']); ?></strong></td>
                                    <td class="actions-cell">
                                        <a href="editar_categoria.php?id=<?php echo $categoria['id_categoria']; ?>"
                                            class="edit-btn" title="Editar"><i class='bx bxs-edit'></i></a>
                                        <a href="admin_categorias.php?action=delete&id=<?php echo $categoria['id_categoria']; ?>"
                                            class="delete-btn" title="Excluir"
                                            onclick="return confirm('Tem certeza que deseja excluir a categoria \'<?php echo addslashes($categoria['nome_categoria']); ?>\'? Produtos associados a ela ficarão sem categoria.');">
